...
TEST_CASE("testing http_tokenizer::normalizer()") {
    ...
    // keep fragments
    REQUIRE(*http_normalizer::normalize("hTt%50://hostname.x:443/path/?b=2&a=1#frag", HTTP_NORMALIZER_FLAGS|http_normalizer::OPT::KEEP_FRAGMENT)  == "http://hostname.x:443/path/?a=1&b=2#frag");
